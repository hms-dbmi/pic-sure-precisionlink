...
INSERT INTO connection VALUES ( UNHEX('B6BD9D7F9E3311ECA5F4126ACB86EEFB'), 'BCH-ADFS', 'BCH-ADFS','adfs|BCH-ADFS|','[{"label":"BCH Email", "id":"email"}]');

-- Create the userMetadataMapping for BCH-ADFS

INSERT INTO userMetadataMapping VALUES 
(unhex('24FD002DC322B0D8420F338F885D0ED5'), '$.email', UNHEX('B6BD9D7F9E3311ECA5F4126ACB86EEFB'), '$.email');
...
insert into user  (select UNHEX(REPLACE(uuid(), '-', '')), NULL, general_metadata, acceptedTOS, UNHEX('B6BD9D7F9E3311ECA5F4126ACB86EEFB'),email,0x00,NULL,is_active,NULL from user where lower(email) like "%childrens%");
