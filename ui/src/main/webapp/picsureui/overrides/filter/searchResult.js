    ...
    function(spinner, BB, HBS, searchResultTemplate, search, settings){
        ...
        var searchResultView = BB.View.extend({
            initialize: function(opts){
                ...
                this.targetCatgegory = opts.targetCategory;
		    ...
		    anyRecordSelect: function (event, data){
	            ...
	            if(value){
	            	...
	            	//we should have one or both of targetCategory and data.pui.  data.pui is generated for hierarchy clicks
	            	// targetCategory is set when we find parent category matches.
	            	...
	            	console.log("DOES THIS EVER HAPPEN???");  //I don't think so
	            }
	        ...
	        toggleTree: function () {
	            var puiSegments = this.targetCatgegory ? this.targetCatgegory.split("\\") : this.model.get("tooltip").split("\\");
	            var finalTree;
	            var prevNode;
	        ...
	        onClick : function(event, data){
	            ...
	            if(this.targetCatgegory){
	            	this.anyRecordSelect(event, data);
	            	return;
	            }
